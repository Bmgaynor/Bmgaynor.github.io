...
const config = {
    title: 'Bradley Gaynor',        // Your website title
    url: 'www.bradgaynor.com',          // Your website URL
    project: 'bmgaynor',      // Firebase project. See README.md -> How to Deploy
...
tasks.set('publish', () => {
    const remote = {
        url: 'https://github.com/Bmgaynor/Bmgaynor.github.io.git', // TODO: Update deployment URL
        branch: 'master',
    };
    global.DEBUG = process.argv.includes('--debug') || false;
